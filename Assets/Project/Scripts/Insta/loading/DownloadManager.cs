...
public class DownloadManager : MonoBehaviour
{
    ...
    public const string less6Error = "_error_less6";
    ...
    private void ConvertTexturesToSprites()
    {
        ...
        {
            sprites.Add(Sprite.Create(postInfo.StandartTexture, new Rect(0f, 0f, postInfo.StandartTexture.width, postInfo.StandartTexture.height), new Vector2(0.5f,0.5f), 100f, 1, SpriteMeshType.FullRect));
        }
    }
